    ...
    <div id="wd-lab1">
      ...
      <div id="wd-h-tag">
        ...
        <p>
          ...
          For instance this paragraph is preceded by the heading Heading Tags. The font of the section headings are
          usually larger and bolder than their subsection headings. This document uses headings to introduce topics
      ...
      <div id="wd-p-tag">
        ...
        <p id="wd-p-2">
          This is the second paragraph. Even though there is a deliberate white gap between the paragraph above and this paragraph,
          by default browsers render them as one contiguous piece of text as shown here on the right.
        </p>
        <p id="wd-p-3">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Boil noodles.</li>
          <li>Prepare sauce with soy sauce, sweet and chili, garlic paste.</li>
          <li>Heat sesame oil.</li>
          <li>Mix sauce with noodles and pour sesame oil over.</li>
        </ol>
      </div>
      ...
      <div id="wd-tables">
        ...
        <table border={1} width="100%">
          ...
          <tbody>
            ...
            <tr><td>Q6</td><td>Node.js</td><td>3/10/21</td><td>87</td></tr>
            <tr><td>Q7</td><td>MongoDB</td><td>3/17/21</td><td>93</td></tr>
            <tr><td>Q8</td><td>APIs</td><td>3/24/21</td><td>89</td></tr>
            <tr><td>Q9</td><td>Security</td><td>3/31/21</td><td>91</td></tr>
            <tr><td>Q10</td><td>Deployment</td><td>4/7/21</td><td>94</td></tr>
          </tbody>
          <tfoot>
            <tr>
      ...
      <div id="wd-images">
        ...
        <Image
          ...
          alt="Starship on the launch pad"
          width={400}
          height={250}
          unoptimized
        />
      ...
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
          ...
          <input placeholder="suripeddis" id="wd-text-fields-username" /> <br />

          <label htmlFor="wd-text-fields-password">Password:</label>
          <input type="password" defaultValue="123@#$asd" id="wd-text-fields-password" /><br />

          <label htmlFor="wd-text-fields-first-name">First name:</label>
          <input type="text" title="Saumya" id="wd-text-fields-first-name" /> <br />

          <label htmlFor="wd-text-fields-last-name">Last name:</label>
          <input
            type="text"
            placeholder="Suripeddi"
      ...
      <input type="email" placeholder="saumyasuripeddi@gmail.com" id="wd-text-fields-email" /><br />
